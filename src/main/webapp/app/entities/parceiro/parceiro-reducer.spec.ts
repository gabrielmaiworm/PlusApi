...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parceiro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARCEIRO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARCEIRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARCEIRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARCEIRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARCEIRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARCEIRO actions', async () => {
      const expectedActions = [
        {
