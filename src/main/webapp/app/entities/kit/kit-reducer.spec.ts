...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_KIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KIT actions', async () => {
      const expectedActions = [
        {
