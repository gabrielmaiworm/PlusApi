...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTABANCARIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTABANCARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTABANCARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTABANCARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTABANCARIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTABANCARIA actions', async () => {
      const expectedActions = [
        {
