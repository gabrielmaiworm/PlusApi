...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCIONARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUNCIONARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNCIONARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNCIONARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNCIONARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNCIONARIO actions', async () => {
      const expectedActions = [
        {
