...
export const Endereco = (props: RouteComponentProps<{ url: string }>) => {
    ...
    <div>
      ...
      <div className="table-responsive">
        {enderecoList && enderecoList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/endereco/${endereco.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
          ...
          !loading && <div className="alert alert-warning">No Enderecos found</div>
        )}
      </div>
    </div>
  );
