...
/**
 * REST controller for managing {@link com.apiplus.domain.Funcionario}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Funcionario> result = funcionarioRepository
            ...
            .map(existingFuncionario -> {
                if (funcionario.getNivelAcesso() != null) {
                    existingFuncionario.setNivelAcesso(funcionario.getNivelAcesso());
                }
                if (funcionario.getNome() != null) {
                    existingFuncionario.setNome(funcionario.getNome());
                }
                if (funcionario.getSobrenome() != null) {
                    existingFuncionario.setSobrenome(funcionario.getSobrenome());
                }
                if (funcionario.getDocumento() != null) {
                    existingFuncionario.setDocumento(funcionario.getDocumento());
                }
